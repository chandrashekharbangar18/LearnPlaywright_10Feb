...
console.log(p.getChild1()); // Logs: "Vrad" (Getter method safely reads the private field)
p.setChild1("Akash0011");   // Sets the private field #child1 to "Akash0011"
console.log(p.getChild1()); // Logs: "Akash0011" (Getter method safely reads the updated private field)
